      ...
      for (i = 0; i < list.length; ++i) {
        ...
        if (isInstance(buf3, Uint8Array)) {
          if (pos + buf3.length > buffer.length) {
            if (!Buffer3.isBuffer(buf3)) buf3 = Buffer3.from(buf3);
...
var require_content_type = __commonJS({
  "node_modules/.deno/content-type@1.0.5/node_modules/content-type/index.js"(exports) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/primordials.js
var require_primordials = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/primordials.js"(exports, module) {
    "use strict";
...
`;
    ...
    module.exports = {
      ...
      TypedArrayPrototypeSet(self2, buf3, len) {
        return self2.set(buf3, len);
      },
      Boolean,
      Uint8Array
    };
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/util/inspect.js
var require_inspect = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/util/inspect.js"(exports, module) {
    "use strict";
    module.exports = {
      format(format, ...args) {
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/errors.js
var require_errors = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/errors.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/abort-controller@3.0.0/node_modules/abort-controller/browser.js
var require_browser = __commonJS({
  "node_modules/.deno/abort-controller@3.0.0/node_modules/abort-controller/browser.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/util.js
var require_util = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/util.js"(exports, module) {
    "use strict";
    var bufferModule = require_buffer();
    var { format, inspect } = require_inspect();
    var { codes: { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2 } } = require_errors();
    ...
    var validateAbortSignal = (signal2, name) => {
      if (signal2 !== void 0 && (signal2 === null || typeof signal2 !== "object" || !("aborted" in signal2))) {
        throw new ERR_INVALID_ARG_TYPE2(name, "AbortSignal", signal2);
      }
    };
    ...
    module.exports = {
      ...
      addAbortListener: require_events().addAbortListener || function addAbortListener(signal2, listener) {
        if (signal2 === void 0) {
          throw new ERR_INVALID_ARG_TYPE2("signal", "AbortSignal", signal2);
        }
        validateAbortSignal(signal2, "signal");
      ...
      AbortSignalAny: AbortSignal2.any || function AbortSignalAny(signals) {
        ...
        signals.forEach((signal2) => {
          validateAbortSignal(signal2, "signals");
          signal2.addEventListener("abort", abort, {
            once: true
          });
        });
        ac.signal.addEventListener("abort", () => {
          signals.forEach((signal2) => signal2.removeEventListener("abort", abort));
        }, {
          once: true
        });
        return ac.signal;
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/validators.js
var require_validators = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/validators.js"(exports, module) {
    "use strict";
    ...
    var { hideStackFrames, codes: { ERR_SOCKET_BAD_PORT, ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_INVALID_ARG_VALUE: ERR_INVALID_ARG_VALUE2, ERR_OUT_OF_RANGE, ERR_UNKNOWN_SIGNAL } } = require_errors();
    ...
    function validateAbortSignalArray(value, name) {
      validateArray(value, name);
      for (let i = 0; i < value.length; i++) {
        const signal2 = value[i];
        const indexedName = `${name}[${i}]`;
        if (signal2 == null) {
          throw new ERR_INVALID_ARG_TYPE2(indexedName, "AbortSignal", signal2);
        }
        validateAbortSignal(signal2, indexedName);
      }
    }
    function validateSignalName(signal2, name = "signal") {
      validateString(signal2, name);
      if (signals[signal2] === void 0) {
        if (signals[StringPrototypeToUpperCase(signal2)] !== void 0) {
          throw new ERR_UNKNOWN_SIGNAL(signal2 + " (signals must use all capital letters)");
        }
        throw new ERR_UNKNOWN_SIGNAL(signal2);
      }
    }
    ...
    var validateAbortSignal = hideStackFrames((signal2, name) => {
      if (signal2 !== void 0 && (signal2 === null || typeof signal2 !== "object" || !("aborted" in signal2))) {
        throw new ERR_INVALID_ARG_TYPE2(name, "AbortSignal", signal2);
      }
    });
    ...
    function validateLinkHeaderFormat(value, name) {
      if (typeof value === "undefined" || !RegExpPrototypeExec(linkValueRegExp, value)) {
        throw new ERR_INVALID_ARG_VALUE2(name, value, 'must be an array or string of format "</styles.css>; rel=preload; as=style"');
      }
    }
    function validateLinkHeaderValue(hints) {
      ...
      throw new ERR_INVALID_ARG_VALUE2("hints", hints, 'must be an array or string of format "</styles.css>; rel=preload; as=style"');
    }
    module.exports = {
      isInt32,
      isUint32,
...
// node_modules/.deno/process@0.11.10/node_modules/process/browser.js
var require_browser2 = __commonJS({
  "node_modules/.deno/process@0.11.10/node_modules/process/browser.js"(exports, module) {
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/utils.js
var require_utils = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/utils.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/end-of-stream.js
var require_end_of_stream = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/end-of-stream.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/destroy.js
var require_destroy = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/destroy.js"(exports, module) {
    "use strict";
    var process = require_browser2();
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/legacy.js
var require_legacy = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/legacy.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/add-abort-signal.js
var require_add_abort_signal = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/add-abort-signal.js"(exports, module) {
    "use strict";
    ...
    var addAbortListener;
    var validateAbortSignal = (signal2, name) => {
      if (typeof signal2 !== "object" || !("aborted" in signal2)) {
        throw new ERR_INVALID_ARG_TYPE2(name, "AbortSignal", signal2);
      }
    };
    module.exports.addAbortSignal = function addAbortSignal(signal2, stream) {
      validateAbortSignal(signal2, "signal");
      ...
      return module.exports.addAbortSignalNoValidate(signal2, stream);
    };
    module.exports.addAbortSignalNoValidate = function(signal2, stream) {
      if (typeof signal2 !== "object" || !("aborted" in signal2)) {
        return stream;
      }
      const onAbort = isNodeStream(stream) ? () => {
        stream.destroy(new AbortError(void 0, {
          cause: signal2.reason
        }));
      } : () => {
      ...
      if (signal2.aborted) {
        ...
        addAbortListener = addAbortListener || require_util().addAbortListener;
        const disposable = addAbortListener(signal2, onAbort);
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/buffer_list.js
var require_buffer_list = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/buffer_list.js"(exports, module) {
    "use strict";
      ...
      *[SymbolIterator]() {
      ...
      _getBuffer(n) {
        ...
        do {
          const buf3 = p.data;
          if (n > buf3.length) {
            TypedArrayPrototypeSet(ret, buf3, retLen - n);
            n -= buf3.length;
          } else {
            if (n === buf3.length) {
              TypedArrayPrototypeSet(ret, buf3, retLen - n);
              ...
              TypedArrayPrototypeSet(ret, new Uint8Array2(buf3.buffer, buf3.byteOffset, n), retLen - n);
              this.head = p;
              p.data = buf3.slice(n);
            }
            break;
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/state.js
var require_state = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/state.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/string_decoder@1.3.0/node_modules/string_decoder/lib/string_decoder.js
var require_string_decoder = __commonJS({
  "node_modules/.deno/string_decoder@1.3.0/node_modules/string_decoder/lib/string_decoder.js"(exports) {
    "use strict";
    ...
    StringDecoder.prototype.write = function(buf3) {
      ...
      if (i < buf3.length) return r ? r + this.text(buf3, i) : this.text(buf3, i);
      return r || "";
    };
    ...
    function utf8Text(buf3, i) {
      ...
      if (!this.lastNeed) return buf3.toString("utf8", i);
    ...
    function base64Text(buf3, i) {
      ...
      if (n === 0) return buf3.toString("base64", i);
      this.lastNeed = 3 - n;
      this.lastTotal = 3;
      if (n === 1) {
        this.lastChar[0] = buf3[buf3.length - 1];
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/from.js
var require_from = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/from.js"(exports, module) {
    "use strict";
    var process = require_browser2();
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/readable.js
var require_readable = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/readable.js"(exports, module) {
    "use strict";
    var process = require_browser2();
    ...
    Readable.prototype.setEncoding = function(enc) {
      const decoder3 = new StringDecoder(enc);
      this._readableState.decoder = decoder3;
      this._readableState.encoding = this._readableState.decoder.encoding;
      const buffer = this._readableState.buffer;
      let content = "";
      for (const data of buffer) {
        content += decoder3.write(data);
      }
      buffer.clear();
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/writable.js
var require_writable = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/writable.js"(exports, module) {
    "use strict";
    var process = require_browser2();
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/duplexify.js
var require_duplexify = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/duplexify.js"(exports, module) {
    var process = require_browser2();
    var bufferModule = require_buffer();
    ...
    function fromAsyncGen(fn) {
      ...
      const value = fn(async function* () {
        while (true) {
          ...
          process.nextTick(cb);
          if (done) return;
          if (signal2.aborted) throw new AbortError(void 0, {
            cause: signal2.reason
          });
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/duplex.js
var require_duplex = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/duplex.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/transform.js
var require_transform = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/transform.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/passthrough.js
var require_passthrough = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/passthrough.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/pipeline.js
var require_pipeline = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/pipeline.js"(exports, module) {
    var process = require_browser2();
    ...
    function pipelineImpl(streams, callback, opts) {
      ...
      if (signal2 !== null && signal2 !== void 0 && signal2.aborted || outerSignal !== null && outerSignal !== void 0 && outerSignal.aborted) {
        process.nextTick(abort);
      }
      return ret;
    }
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/compose.js
var require_compose = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/compose.js"(exports, module) {
    "use strict";
    ...
    var { AbortError, codes: { ERR_INVALID_ARG_VALUE: ERR_INVALID_ARG_VALUE2, ERR_MISSING_ARGS } } = require_errors();
    var eos = require_end_of_stream();
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/operators.js
var require_operators = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/operators.js"(exports, module) {
    "use strict";
    var AbortController2 = globalThis.AbortController || require_browser().AbortController;
    var { codes: { ERR_INVALID_ARG_VALUE: ERR_INVALID_ARG_VALUE2, ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_MISSING_ARGS, ERR_OUT_OF_RANGE }, AbortError } = require_errors();
    ...
    function compose(stream, options) {
      ...
      if (isNodeStream(stream) && !isWritable(stream)) {
        throw new ERR_INVALID_ARG_VALUE2("stream", stream, "must be writable");
      }
    ...
    function map(fn, options) {
      ...
      return async function* map2() {
        const signal2 = require_util().AbortSignalAny([
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/stream/promises.js
var require_promises = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/stream/promises.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/stream.js
var require_stream = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/stream.js"(exports, module) {
    "use strict";
    var { Buffer: Buffer3 } = require_buffer();
...
// node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/browser.js
var require_browser3 = __commonJS({
  "node_modules/.deno/readable-stream@4.7.0/node_modules/readable-stream/lib/ours/browser.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/@bergos+jsonparse@1.4.2/node_modules/@bergos/jsonparse/jsonparse.js
var require_jsonparse = __commonJS({
  "node_modules/.deno/@bergos+jsonparse@1.4.2/node_modules/@bergos/jsonparse/jsonparse.js"(exports, module) {
    var { Buffer: Buffer3 } = require_buffer();
    var C = {};
    ...
    proto.appendStringBuf = function(buf3, start, end) {
      var size = buf3.length;
      if (typeof start === "number") {
        if (typeof end === "number") {
          if (end < 0) {
            size = buf3.length - start + end;
          } else {
            size = end - start;
          }
        } else {
          size = buf3.length - start;
        }
      }
      if (size < 0) {
        size = 0;
      ...
      buf3.copy(this.stringBuffer, this.stringBufferOffset, start, end);
...
// node_modules/.deno/relative-to-absolute-iri@1.0.8/node_modules/relative-to-absolute-iri/lib/Resolve.js
var require_Resolve = __commonJS({
  "node_modules/.deno/relative-to-absolute-iri@1.0.8/node_modules/relative-to-absolute-iri/lib/Resolve.js"(exports) {
    "use strict";
...
// node_modules/.deno/relative-to-absolute-iri@1.0.8/node_modules/relative-to-absolute-iri/index.js
var require_relative_to_absolute_iri = __commonJS({
  "node_modules/.deno/relative-to-absolute-iri@1.0.8/node_modules/relative-to-absolute-iri/index.js"(exports) {
    "use strict";
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/ErrorCoded.js
var require_ErrorCoded = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/ErrorCoded.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/http-link-header@1.1.4/node_modules/http-link-header/lib/link.js
var require_link = __commonJS({
  "node_modules/.deno/http-link-header@1.1.4/node_modules/http-link-header/lib/link.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/FetchDocumentLoader.js
var require_FetchDocumentLoader = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/FetchDocumentLoader.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/Util.js
var require_Util = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/Util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/JsonLdContextNormalized.js
var require_JsonLdContextNormalized = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/JsonLdContextNormalized.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/ContextParser.js
var require_ContextParser = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/ContextParser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
        ...
        for (const key of Object.keys(context)) {
          ...
          if (value && typeof value === "object") {
            if (value["@reverse"] && !value["@id"]) {
              ...
              value = context[key] = Object.assign(Object.assign({}, value), {
                "@id": value["@reverse"]
              });
              ...
              if (typeof value === "string") {
                ...
                if ("@id" in value) {
                  if (id !== void 0 && id !== null && typeof id === "string") {
                    contextRaw[key] = Object.assign(Object.assign({}, contextRaw[key]), {
                      "@id": context.expandTerm(id, true)
                    });
              ...
              if (value && typeof value === "object") {
                if (typeof value["@language"] === "string") {
                  ...
                  if (lowercase !== value["@language"]) {
                    context[key] = Object.assign(Object.assign({}, value), {
                      "@language": lowercase
                    });
                  }
                }
              ...
              if (!Util_1.Util.isPotentialKeyword(key) && !Util_1.Util.isTermProtected(context, key)) {
                ...
                if (value && typeof value === "object") {
                  if (!("@protected" in context[key])) {
                    context[key] = Object.assign(Object.assign({}, context[key]), {
                      "@protected": true
                    });
                  }
                } else {
        ...
        for (const key of keys !== null && keys !== void 0 ? keys : Object.keys(contextAfter)) {
          if (Util_1.Util.isTermProtected(contextBefore, key)) {
            if (typeof contextAfter[key] === "string") {
              ...
              contextAfter[key] = Object.assign(Object.assign({}, contextAfter[key]), {
                "@protected": true
              });
            }
          ...
          if (value && typeof value === "object") {
            if ("@context" in value && value["@context"] !== null && !options.ignoreScopedContexts) {
              if (this.validateContext) {
                try {
                  const parentContext = Object.assign(Object.assign({}, context), {
                    [key]: Object.assign({}, context[key])
                  });
              ...
              context[key] = Object.assign(Object.assign({}, value), {
                "@context": (await this.parse(value["@context"], Object.assign(Object.assign({}, options), {
                  external: false,
...
Tried mapping @context to ${JSON.stringify(context["@context"])}`, ErrorCoded_1.ERROR_CODES.KEYWORD_REDEFINITION);
          ...
          this.applyScopedProtected(importContext, {
            processingMode
          }, JsonLdContextNormalized_1.defaultExpandOptions);
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/IDocumentLoader.js
var require_IDocumentLoader = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/IDocumentLoader.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/JsonLdContext.js
var require_JsonLdContext = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/lib/JsonLdContext.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/index.js
var require_jsonld_context_parser = __commonJS({
  "node_modules/.deno/jsonld-context-parser@3.1.1/node_modules/jsonld-context-parser/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/BlankNode.js
var require_BlankNode = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/BlankNode.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/DefaultGraph.js
var require_DefaultGraph = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/DefaultGraph.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/NamedNode.js
var require_NamedNode = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/NamedNode.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/Literal.js
var require_Literal = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/Literal.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/Quad.js
var require_Quad = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/Quad.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/Variable.js
var require_Variable = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/Variable.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/DataFactory.js
var require_DataFactory = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/lib/DataFactory.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/index.js
var require_rdf_data_factory = __commonJS({
  "node_modules/.deno/rdf-data-factory@2.0.2/node_modules/rdf-data-factory/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerIdentifier.js
var require_ContainerHandlerIdentifier = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerIdentifier.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var ContainerHandlerIdentifier = class {
      ...
      async handle(containers, parsingContext, util, keys, value, depth) {
        ...
        if (parsingContext.emittedStack[depth + 1] && parsingContext.idStack[depth + 1]) {
          ...
          id = maybeId;
          parsingContext.idStack[depth + 1] = [
            id
          ];
        }
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerPredicate.js
var require_EntryHandlerPredicate = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerPredicate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerIndex.js
var require_ContainerHandlerIndex = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerIndex.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerLanguage.js
var require_ContainerHandlerLanguage = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerLanguage.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerType.js
var require_ContainerHandlerType = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/containerhandler/ContainerHandlerType.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerContainer.js
var require_EntryHandlerContainer = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerContainer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/canonicalize@1.0.8/node_modules/canonicalize/lib/canonicalize.js
var require_canonicalize = __commonJS({
  "node_modules/.deno/canonicalize@1.0.8/node_modules/canonicalize/lib/canonicalize.js"(exports, module) {
    "use strict";
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/Util.js
var require_Util2 = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/Util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Util = class _Util {
      ...
      static getContextValueContainer(context, key) {
        return _Util.getContextValue(context, "@container", key, {
          "@set": true
        });
      }
      /**
      ...
      async valueToTerm(context, key, value, depth, keys) {
        if (_Util.getContextValueType(context, key) === "@json") {
          return [
            this.dataFactory.literal(this.valueToJsonString(value), this.rdfJson)
          ];
        }
          ...
          case "object":
            ...
            if ("@value" in value) {
              ...
              if (await this.unaliasKeyword(valueType, keys, depth, true, context) === "@json") {
                return [
                  this.dataFactory.literal(this.valueToJsonString(val), this.rdfJson)
                ];
              }
              if (val === null) {
                return [];
              ...
              if (valueLanguage && valueDirection) {
                ...
                return [
                  this.dataFactory.literal(val, valueLanguage)
                ];
                ...
                return [
                  this.dataFactory.literal(val, typeTerm)
                ];
              }
              ...
              return graphContainerEntries ? Object.values(graphContainerEntries) : [
              ...
              if (this.parsingContext.emittedStack[depth + 1] || value && typeof value === "object" && Object.keys(value).length === 0) {
                return this.parsingContext.idStack[depth + 1] || (this.parsingContext.idStack[depth + 1] = [
                  this.dataFactory.blankNode()
                ]);
              } else {
                return [];
      ...
      emitQuadChecked(depth, subject, predicate, object, graph, reverse, isEmbedded) {
        ...
        if (reverse) {
          ...
          quad3 = this.dataFactory.quad(object, predicate, subject, graph);
        } else {
          quad3 = this.dataFactory.quad(subject, predicate, object, graph);
        }
        if (isEmbedded) {
          ...
          this.parsingContext.idStack[depth - 1] = [
            quad3
          ];
        } else {
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerArrayValue.js
var require_EntryHandlerArrayValue = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerArrayValue.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerInvalidFallback.js
var require_EntryHandlerInvalidFallback = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/EntryHandlerInvalidFallback.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeyword.js
var require_EntryHandlerKeyword = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeyword.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordContext.js
var require_EntryHandlerKeywordContext = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordContext.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordGraph.js
var require_EntryHandlerKeywordGraph = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordGraph.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordId.js
var require_EntryHandlerKeywordId = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordId.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordIncluded.js
var require_EntryHandlerKeywordIncluded = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordIncluded.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordNest.js
var require_EntryHandlerKeywordNest = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordNest.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordType.js
var require_EntryHandlerKeywordType = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordType.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
        ...
        if (hasTypedScopedContext) {
          scopedContext = scopedContext.then((c) => {
            if (c.getContextRaw()["@propagate"] !== true) {
              return new jsonld_context_parser_1.JsonLdContextNormalized(Object.assign(Object.assign({}, c.getContextRaw()), {
                "@propagate": false,
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordUnknownFallback.js
var require_EntryHandlerKeywordUnknownFallback = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordUnknownFallback.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordValue.js
var require_EntryHandlerKeywordValue = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordValue.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/ContextTree.js
var require_ContextTree = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/ContextTree.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      getContext(keys) {
        if (keys.length > 0) {
          ...
          if (subTree) {
            ...
            if (subContext) {
              return subContext.then(({ context, depth }) => ({
                context,
                depth: depth + 1
              }));
            }
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/ParsingContext.js
var require_ParsingContext = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/ParsingContext.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordAnnotation.js
var require_EntryHandlerKeywordAnnotation = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/entryhandler/keyword/EntryHandlerKeywordAnnotation.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/JsonLdParser.js
var require_JsonLdParser = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/lib/JsonLdParser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var JsonLdParser2 = class _JsonLdParser extends readable_stream_1.Transform {
      ...
      async newOnValueJob(keys, value, depth, lastDepthCheck) {
        ...
        if (lastDepthCheck && depth < this.lastDepth) {
          ...
          if (listPointer) {
            ...
            this.parsingContext.idStack[listPointer.listRootDepth + 1] = [
              listPointer.listId
            ];
      ...
      async flushBuffer(depth, keys) {
        ...
        if (!subjectsWasDefined) {
          subjects = this.parsingContext.idStack[depth] = [
        ...
        if (valueBuffer) {
          for (const subject of subjects) {
            ...
            const graphs = this.parsingContext.graphStack[depth] || depthOffsetGraph >= 0 ? this.parsingContext.idStack[depth - depthOffsetGraph - 1] : [
      ...
      async executeBufferedJobs() {
        ...
        for (const job of this.contextAwaitingJobs) {
          if (await this.util.unaliasKeyword(job.keys[job.depth], job.keys, job.depth, true) === "@type" || typeof job.keys[job.depth] === "number" && await this.util.unaliasKeyword(job.keys[job.depth - 1], job.keys, job.depth - 1, true) === "@type") {
            this.typeJobs.push({
              job: job.job,
              keys: job.keys.slice(0, job.keys.length - 1)
            });
          } else {
...
// node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/index.js
var require_jsonld_streaming_parser = __commonJS({
  "node_modules/.deno/jsonld-streaming-parser@5.0.1/node_modules/jsonld-streaming-parser/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
// node_modules/.deno/@solid+reactive-authentication@0.1.3/node_modules/@solid/reactive-authentication/dist/Mutex.js
var Mutex = class {
  ...
  // TODO: Abort signal?
  async acquire() {
    const { promise: next, resolve: release } = Promise.withResolvers();
...
// node_modules/.deno/@solid+reactive-authentication@0.1.3/node_modules/@solid/reactive-authentication/dist/ReactiveAuthenticationError.js
var ReactiveAuthenticationError = class extends Error {
...
// node_modules/.deno/@solid+reactive-authentication@0.1.3/node_modules/@solid/reactive-authentication/dist/CodeRequestCancelledError.js
var CodeRequestCancelledError = class extends ReactiveAuthenticationError {
  authorizationRequest;
  constructor(authorizationRequest, cause) {
...
// node_modules/.deno/@solid+reactive-authentication@0.1.3/node_modules/@solid/reactive-authentication/dist/AuthorizationCodeFlow.js
...
var authorizationWindowName = "oidcAuthentication";
var onlyOnce = {
  once: true
};
var html = `
...
`;
var AuthorizationCodeFlow = class extends HTMLElement {
  #mutex = new Mutex();
  #newModal;
  #switchModal;
  #authorizationWindow;
  ...
  /**
     ...
     * ```
     */
  async getCode(authorizationUri, signal2) {
    const env_1 = {
      stack: [],
      error: void 0,
      hasError: false
    ...
    try {
      ...
      const { promise: responseFromPopup, reject: cancelCodeRequest, resolve: respondWithCode } = Promise.withResolvers();
      ...
      const onAbort = () => {
        ...
        this.#switchModal.close();
        this.#authorizationWindow?.close();
        cancelCodeRequest(signal2.reason);
      };
      signal2.addEventListener("abort", onAbort, onlyOnce);
  ...
  #cancel() {
    ...
    this.#switchModal.close();
    this.#authorizationWindow?.close();
    this.#cancelCodeRequest?.call(void 0, new CodeRequestCancelledError(this.#authorizationUri));
  }
};
customElements.define("authorization-code-flow", AuthorizationCodeFlow);

// node_modules/.deno/oauth4webapi@3.8.6/node_modules/oauth4webapi/build/index.js
var USER_AGENT;
...
function assertContentType(response, contentType2) {
  if (getContentType(response) !== contentType2) {
    throw notJson(response, contentType2);
  }
}
...
function validateEndpoint(value, endpoint, useMtlsAlias, enforceHttps) {
  ...
  if (typeof value !== "string" || !(url = URLParse(value))) {
    throw OPE(`authorization server metadata does not contain a valid ${useMtlsAlias ? `"as.mtls_endpoint_aliases.${endpoint}"` : `"as.${endpoint}"`}`, value === void 0 ? MISSING_SERVER_METADATA : INVALID_SERVER_METADATA, {
  ...
  switch (expectedState) {
    ...
    default:
      ...
      if (state !== expectedState) {
        throw OPE(state === void 0 ? 'response parameter "state" missing' : 'unexpected "state" response parameter value', INVALID_RESPONSE, {
...
// node_modules/.deno/dpop@2.1.1/node_modules/dpop/build/index.js
...
function checkRsaKeyAlgorithm2(algorithm) {
  if (typeof algorithm.modulusLength !== "number" || algorithm.modulusLength < 2048) {
    throw new OperationProcessingError2(`${algorithm.name} modulusLength must be at least 2048 bits`);
  }
}
function subtleAlgorithm(key) {
  switch (key.algorithm.name) {
    ...
    case "RSA-PSS":
      checkRsaKeyAlgorithm2(key.algorithm);
      return {
        name: key.algorithm.name,
        saltLength: 256 >> 3
      };
  ...
  throw new UnsupportedOperationError2();
}
async function jwt(header, claimsSet, key) {
  ...
  const input = `${b64u2(buf2(JSON.stringify(header)))}.${b64u2(buf2(JSON.stringify(claimsSet)))}`;
  const signature = b64u2(await crypto.subtle.sign(subtleAlgorithm(key), key, buf2(input)));
  return `${input}.${signature}`;
}
var encodeBase64Url2;
if (Uint8Array.prototype.toBase64) {
  encodeBase64Url2 = (input) => {
    if (input instanceof ArrayBuffer) {
      input = new Uint8Array(input);
    }
    return input.toBase64({
...
var OperationProcessingError2 = class extends Error {
  constructor(message) {
    var _a;
    super(message);
    this.name = this.constructor.name;
...
function psAlg2(key) {
  switch (key.algorithm.hash.name) {
    case "SHA-256":
      return "PS256";
    default:
      throw new UnsupportedOperationError2("unsupported RsaHashedKeyAlgorithm hash name");
  }
}
function rsAlg2(key) {
  switch (key.algorithm.hash.name) {
...
function esAlg2(key) {
  switch (key.algorithm.namedCurve) {
    case "P-256":
      return "ES256";
    default:
      throw new UnsupportedOperationError2("unsupported EcKeyAlgorithm namedCurve");
  }
}
function determineJWSAlgorithm(key) {
  switch (key.algorithm.name) {
    ...
    case "Ed25519":
      return "Ed25519";
    default:
      throw new UnsupportedOperationError2("unsupported CryptoKey algorithm name");
  }
}
...
async function generateProof(keypair, htu, htm, nonce, accessToken, additional) {
  ...
  return jwt({
    ...
    typ: "dpop+jwt",
    jwk: await publicJwk2(publicKey)
    ...
    nonce,
    htu,
    ath: accessToken ? b64u2(await crypto.subtle.digest("SHA-256", buf2(accessToken))) : void 0
  }), privateKey);
}
async function publicJwk2(key) {
...
// node_modules/.deno/@solid+reactive-authentication@0.1.3/node_modules/@solid/reactive-authentication/dist/ReactiveFetchManager.js
var ReactiveFetchManager = class extends EventTarget {
  #globalFetch;
  #providers;
  ...
  async #fetch(input, init) {
    ...
    const response = await this.#globalFetch.call(void 0, request.clone());
    ...
    return this.#globalFetch.call(void 0, upgraded);
  }
...
// node_modules/.deno/@solid+reactive-authentication@0.1.3/node_modules/@solid/reactive-authentication/dist/IssuerRequestCancelledError.js
var IssuerRequestCancelledError = class extends ReactiveAuthenticationError {
  request;
...
// node_modules/.deno/@solid+reactive-authentication@0.1.3/node_modules/@solid/reactive-authentication/dist/IdpPicker.js
...
`;
var IdpPicker = class extends HTMLElement {
  #mutex = new Mutex();
  #dialog;
  #input;
  #code;
  ...
  async getIssuer(request) {
    ...
    try {
      ...
      request.signal.addEventListener("abort", onAbort, onlyOnce2);
      this.#dialog.addEventListener("close", onClose, onlyOnce2);
...
// client/solid-auth.ts
var BrowserBuffer = __toESM(require_buffer());
var BrowserEvents = __toESM(require_events());

// node_modules/.deno/@jeswr+fetch-rdf@0.1.0/node_modules/@jeswr/fetch-rdf/dist/parse.js
var import_content_type = __toESM(require_content_type());

// node_modules/.deno/@rdfjs+dataset@2.0.3/node_modules/@rdfjs/dataset/DatasetCore.js
function isString(s) {
...
// node_modules/.deno/@rdfjs+dataset@2.0.3/node_modules/@rdfjs/dataset/Factory.js
var Factory = class {
  dataset(quads) {
...
// node_modules/.deno/@rdfjs+dataset@2.0.3/node_modules/@rdfjs/dataset/index.js
var factory = new Factory_default();
var dataset_default = factory;

// node_modules/.deno/n3@2.1.1/node_modules/n3/src/N3Lexer.js
import { Buffer as Buffer2 } from "data:text/javascript,export var Buffer=globalThis.Buffer";

// node_modules/.deno/n3@2.1.1/node_modules/n3/src/IRIs.js
  ...
  _tokenizeToEnd(callback, inputFinished) {
    ...
    while (true) {
      ...
      switch (firstChar) {
        ...
        case "V":
        case "v":
          if (match = this._keyword.exec(input)) type = match[0].toUpperCase();
...
// node_modules/.deno/n3@2.1.1/node_modules/n3/src/N3DataFactory.js
...
// node_modules/.deno/n3@2.1.1/node_modules/n3/src/N3Parser.js
...
var N3Parser = class _N3Parser {
  ...
  _readTripleTermTail(token) {
    ...
    const quad3 = this._factory.quad(this._subject, this._predicate, this._object, this._graph || this.DEFAULTGRAPH);
...
// node_modules/.deno/@jeswr+fetch-rdf@0.1.0/node_modules/@jeswr/fetch-rdf/dist/errors.js
...
async function parseRdf(body, contentTypeHeader, options = {}) {
  ...
  try {
    ...
    throw new RdfFetchError(`Invalid Content-Type header: "${rawHeader}".`, {
      cause,
  ...
  if (N3_FAMILY.has(mediaType)) {
    ...
    try {
      ...
      throw new RdfFetchError(`Failed to parse ${mediaType} body${baseIRI ? ` at ${baseIRI}` : ""}.`, {
        cause,
        contentType: rawHeader,
        ...baseIRI !== void 0 && {
          url: baseIRI
  ...
  throw new RdfFetchError(`Unsupported RDF media type: "${mediaType}". Supported: ${SUPPORTED_RDF_MEDIA_TYPES.join(", ")}.`, {
    contentType: rawHeader,
    ...baseIRI !== void 0 && {
      url: baseIRI
    }
...
// node_modules/.deno/@jeswr+fetch-rdf@0.1.0/node_modules/@jeswr/fetch-rdf/dist/fetch.js
...
async function fetchRdf(url, options = {}) {
  ...
  try {
    ...
    throw new RdfFetchError(`Network error fetching ${url}: ${errorMessage(cause)}`, {
      cause,
      url
    });
  }
  ...
  const dataset = await parseRdf(body, rawContentType, {
    baseIRI: finalUrl
  });
  return {
    dataset,
...
var TermWrapper = class {
  ...
  _dataset;
  _factory;
  constructor(term, dataset, factory2) {
...
var ListItem = class _ListItem extends TermWrapper {
  termAs;
  termFrom;
  constructor(term, dataset, factory2, termAs, termFrom) {
    super(term, dataset, factory2);
    this.termAs = termAs;
...
var LiteralDatatypeError = class extends TermError {
  ...
  constructor(literal3, datatypes, cause) {
    super(literal3, `Datatype must be one of ${[
      ...datatypes
    ].join()} but was ${literal3.datatype}`, cause);
...
(function(LiteralFrom2) {
  ...
  function langString(value, factory2) {
    return factory2.literal(value.string, {
      language: value.lang
    });
  }
  LiteralFrom2.langString = langString;
  function string(value, factory2) {
...
(function(NamedNodeFrom2) {
  ...
  function url(value, factory2) {
    return string(value.toString(), factory2);
  }
...
// node_modules/.deno/@solid+object@0.6.0/node_modules/@solid/object/dist/vocabulary/foaf.js
var FOAF = {
...
// node_modules/.deno/@solid+object@0.6.0/node_modules/@solid/object/dist/vocabulary/pim.js
var PIM = {
  storage: "http://www.w3.org/ns/pim/space#storage"
};

// node_modules/.deno/@solid+object@0.6.0/node_modules/@solid/object/dist/vocabulary/solid.js
var SOLID = {
  oidcIssuer: "http://www.w3.org/ns/solid/terms#oidcIssuer",
  storage: "http://www.w3.org/ns/solid/terms#storage"
};

// node_modules/.deno/@solid+object@0.6.0/node_modules/@solid/object/dist/vocabulary/vcard.js
var VCARD = {
...
// node_modules/.deno/@solid+object@0.6.0/node_modules/@solid/object/dist/webid/Agent.js
...
// node_modules/.deno/n3@1.26.0/node_modules/n3/src/IRIs.js
...
// node_modules/.deno/n3@1.26.0/node_modules/n3/src/N3DataFactory.js
var { rdf: rdf2, xsd: xsd3 } = IRIs_default2;
var DEFAULTGRAPH2;
...
var NamedNode2 = class extends Term2 {
  // ### The term type of this term
  get termType() {
    return "NamedNode";
  }
...
var Literal2 = class _Literal extends Term2 {
  ...
  get datatypeString() {
    ...
    return char === "^" ? id.substr(dtPos + 2) : (
      ...
      char !== "@" ? xsd3.string : rdf2.langString
    );
  }
  // ### Returns whether this object represents the same term as the other
  equals(other) {
...
var BlankNode2 = class extends Term2 {
  constructor(name) {
    super(`_:${name}`);
  }
  // ### The term type of this term
...
DEFAULTGRAPH2 = new DefaultGraph2();
var Quad2 = class extends Term2 {
  constructor(subject, predicate, object, graph) {
    ...
    this._predicate = predicate;
    this._object = object;
    this._graph = graph || DEFAULTGRAPH2;
  }
  // ### The term type of this term
  get termType() {
    return "Quad";
...
function blankNode2(name) {
  return new BlankNode2(name || `n3-${_blankNodeCounter2++}`);
}
function literal2(value, languageOrDataType) {
  ...
  let datatype = languageOrDataType ? languageOrDataType.value : "";
  if (datatype === "") {
    if (typeof value === "boolean") datatype = xsd3.boolean;
    else if (typeof value === "number") {
      if (Number.isFinite(value)) datatype = Number.isInteger(value) ? xsd3.integer : xsd3.double;
      else {
...
function fromTerm2(term) {
  if (term instanceof Term2) return term;
  switch (term.termType) {
    case "NamedNode":
...
// .claude/skills/solid-reactive-authentication/login-ux.ts
var NoSolidIssuerError = class extends Error {
  webId;
  constructor(webId) {
    super(`This WebID can't be used for Solid login \u2014 its profile has no solid:oidcIssuer (${webId}).`);
...
function resolveIssuers(webId, dataset) {
  const agent = new Agent(webId, dataset, N3DataFactory_default2);
  const issuers = [
    ...agent.oidcIssuer
  ];
...
// .claude/skills/solid-reactive-authentication/webid-token-provider.ts
var AmbiguousIssuerError = class extends Error {
  webId;
  issuers;
  constructor(webId, issuers) {
    super(`This WebID advertises ${issuers.length} OIDC issuers \u2014 the app must supply a 'chooseIssuer' callback so the user can pick one (${webId}).`);
    this.name = "AmbiguousIssuerError";
    this.webId = webId;
    this.issuers = issuers;
  }
};
function defaultChooseIssuer(webId) {
  return async (issuers) => {
...
var WebIdDPoPTokenProvider = class {
   ...
   */
  #authSignal = new AbortController().signal;
  constructor(callbackUri, getCode, getWebId, options = {}) {
  ...
  async upgrade(request) {
    ...
    headers.set("DPoP", await generateProof(session.dpopKey, request.url, request.method, void 0, session.accessToken));
  ...
  async #getSession(issuer, signal2) {
    const cached = this.#sessions.get(issuer.href);
    if (cached) return cached;
    const pending = this.#authenticate(issuer, signal2).catch((e) => {
   ...
   */
  async #authenticate(issuer, signal2) {
    const http = this.#httpOptions(issuer, signal2);
    const discoveryResponse = await discoveryRequest(issuer, http);
    ...
    const [registeredRedirectUri] = clientRegistration.redirect_uris ?? [
      this.#callbackUri
    ];
    const [registeredResponseType] = clientRegistration.response_types ?? [
      "code"
    ];
    const dpopKey = await generateKeyPair("ES256", {
      extractable: false
    });
    const dpop = DPoP({}, dpopKey);
    const codeVerifier = generateRandomCodeVerifier();
    const nonce = generateRandomNonce();
    const state = generateRandomState();
    const buildAuthorizationUrl = (withPrompt) => {
      ...
      if (authorizationServer.code_challenge_methods_supported !== void 0) {
    ...
    const usePkce = authorizationServer.code_challenge_methods_supported !== void 0;
    const useS256 = usePkce && authorizationServer.code_challenge_methods_supported.includes("S256");
    const codeChallenge = useS256 ? await calculatePKCECodeChallenge(codeVerifier) : codeVerifier;
    ...
    const authorizationCodeResponse = await this.#getCode(authorizationUrl, signal2);
    try {
      authorizationCodeParams = validateAuthResponse(authorizationServer, clientRegistration, new URL(authorizationCodeResponse), state);
    } catch (e) {
      if (e instanceof AuthorizationResponseError && (e.error === "interaction_required" || e.error === "consent_required" || e.error === "login_required") || isEssMissingIssInteractionNeeded(e)) {
        const retryUrl = buildAuthorizationUrl(false);
        if (usePkce) retryUrl.searchParams.set("code_challenge", codeChallenge);
        const retryResponse = await this.#getCode(retryUrl, signal2);
        authorizationCodeParams = validateAuthResponse(authorizationServer, clientRegistration, new URL(retryResponse), state);
      } else {
        throw e;
      }
    }
    const tokenResponse = await authorizationCodeGrantRequest(authorizationServer, clientRegistration, this.#clientAuth(authorizationServer.issuer, clientRegistration), authorizationCodeParams, this.#callbackUri, usePkce ? codeVerifier : nopkce, {
      DPoP: dpop,
      ...http
    });
    if (!tokenResponse.ok) {
      const detail = await tokenResponse.clone().text();
      throw new Error(`Solid token endpoint returned ${tokenResponse.status}: ${detail || "no response body"}`);
    }
    const tokenResult = await processAuthorizationCodeResponse(authorizationServer, clientRegistration, tokenResponse, {
  ...
  async #resolveClient(authorizationServer, http) {
    ...
    const registrationResponse = await dynamicClientRegistrationRequest(authorizationServer, {
      redirect_uris: [
        this.#callbackUri
      ]
    }, http);
    return processDynamicClientRegistrationResponse(registrationResponse);
  }
  /** Client authentication, mirroring the published provider's ESS workaround. */
  #clientAuth(issuer, client) {
    if (client.token_endpoint_auth_method === "client_secret_basic") {
      return clientSecretBasicFor(issuer)(client.client_secret);
    }
    return None();
  }
  /** Some servers (NSS/ESS variants) omit the nonce; expect none for them. */
  #nonceVerification(issuer, nonce) {
    if (issuer === "https://datapod.igrant.io" || issuer === "https://solidweb.org") {
      return expectNoNonce;
    }
    return nonce;
  }
};
function isEssMissingIssInteractionNeeded(e) {
  try {
    return e.cause.parameters.get("error") === "interaction_required";
  } catch {
    return false;
  }
}
...
// client/solid-auth.ts
var WEBID_KEY = "comidas.gratis.webid";
var STATIC_CLIENT_ID = "https://raw.githubusercontent.com/comidasgratis/comidas.gratis/main/public/client-id.jsonld";
var _initialized = false;
function setupAuth(getWebId) {
  if (_initialized) return;
  const ui = document.querySelector("authorization-code-flow");
  const callbackUri = new URL("/callback.html", location.href).toString();
  const provider = new WebIdDPoPTokenProvider(callbackUri, ui.getCode.bind(ui), async () => validateWebId(getWebId()), {
...
function getStoredWebId() {
  return localStorage.getItem(WEBID_KEY);
}
function setStoredWebId(webId) {
  localStorage.setItem(WEBID_KEY, webId);
}
function clearStoredWebId() {
